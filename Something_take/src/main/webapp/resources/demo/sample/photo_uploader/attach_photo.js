    ...
    function html5Upload() {	
    	...
    	sUploadURL= '${pageContext.request.contextPath}/resources/demo/sample/photo_uploader/file_uploader_html5.php'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '${pageContext.request.contextPath}/resources/demo/sample/photo_uploader/file_uploader.php',	//샘플 URL입니다.
// 			sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader.php',	//샘플 URL입니다.
 	        sCallback : '${pageContext.request.contextPath}/resources/demo/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
