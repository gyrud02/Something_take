						...
						<div class="col-md-7 col-sm-12 ml-md-auto mr-md-auto">
							<div class="pricing_item">
								...
								<div class="pricing_body bg-white p-top-110 p-bottom-60">
									<ul>
										<li><i class="fa fa-check-circle text-primary"></i> <span>멤버십 : </span> ${membership.membership_type}</li>
										<li><i class="fa fa-check-circle text-primary"></i> <span>결제일 : </span> ${membership.membership_reg_date}</li>
										<li><i class="fa fa-check-circle text-primary"></i> <span>종료일 : </span> ${membership.membership_end_date}</li>
	
									</ul>
									<div class="pricing_btn text-center m-top-40">
										<a href="Payment.pm"
										   class="btn btn-primary">멤버십 변경하기</a>
										<a href="#"
										   class="btn btn-primary">멤버십 해지하기</a>
									</div>
								</div>
						...
						<div class="col-md-8 col-sm-12 ml-md-auto mr-md-auto">
							<div class="pricing_item">
								<div class="pricing_body bg-white p-top-110 p-bottom-60">
									...
									<div class="pricing_btn text-center m-top-40">
										<a href="Payment.pm"
										   class="btn btn-primary">멤버십 신청하기</a>
									</div>
								</div>
